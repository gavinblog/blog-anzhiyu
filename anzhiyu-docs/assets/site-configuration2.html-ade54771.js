import{_ as d,M as u,p as r,q as m,R as n,t as s,N as a,V as t,a1 as p}from"./framework-2fd1fcd7.js";const k={},v={class:"hint-container warning"},b=n("p",{class:"hint-container-title"},"警告",-1),h={href:"https://github.com/anzhiyu-c/hexo-theme-anzhiyu/releases/tag/1.2.1",target:"_blank",rel:"noopener noreferrer"},g=p(`<h2 id="footer-设置" tabindex="-1"><a class="header-anchor" href="#footer-设置" aria-hidden="true">#</a> Footer 设置</h2><p><code>since</code> 是一个来展示你站点起始时间的选项。它位于页面的最底部。</p><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token comment"># Footer Settings</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="标签外挂-tag-plugins" tabindex="-1"><a class="header-anchor" href="#标签外挂-tag-plugins" aria-hidden="true">#</a> 标签外挂（Tag Plugins）</h2><div class="hint-container info"><p class="hint-container-title">相关信息</p><p>标签外挂是 Hexo 独有的功能，并不是标准的 Markdown 格式。 以下的写法，只适用于 AnZhiYu 主题，用在其它主题上不会有效果，甚至可能会报错。使用前请留意</p></div><div class="hint-container warning"><p class="hint-container-title">警告</p><p>标签外挂虽然能为主题带来一些额外的功能和 UI 方面的强化，但是，标签外挂也有明显的限制，使用时请留意。</p></div>`,45),f={href:"https://anzhiy.cn/posts/d50a.html",target:"_blank",rel:"noopener noreferrer"},x=n("h2",{id:"分析统计",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#分析统计","aria-hidden":"true"},"#"),s(" 分析统计")],-1),q={href:"https://tongji.baidu.com/web/welcome/login?castk=LTE%3D",target:"_blank",rel:"noopener noreferrer"},w=n("li",null,[n("p",null,"找到你百度统计的统计代码")],-1),j=n("figure",null,[n("img",{src:"https://bu.dusays.com/2023/06/02/64795c52dff22.jpg",alt:"",tabindex:"0",loading:"lazy"}),n("figcaption")],-1),z=n("ol",{start:"3"},[n("li",null,[s("修改 "),n("code",null,"主题配置文件")])],-1),C=n("div",{class:"language-yaml line-numbers-mode","data-ext":"yml"},[n("pre",{class:"language-yaml"},[n("code",null,[n("span",{class:"token key atrule"},"baidu_analytics"),n("span",{class:"token punctuation"},":"),s(` 你的代码
